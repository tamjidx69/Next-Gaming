...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen flex flex-col justify-center items-center px-6 overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center macos-card p-12 md:p-24 relative mt-20">
        <div className="macos-window-header">
          ...
          <div className="ml-4 text-[10px] font-medium text-white/20 uppercase tracking-widest hidden sm:block">next-gaming-portfolio.dmg</div>
        </div>
        ...
        <div className="flex flex-col items-center mt-6">
          ...
          >
            <img src="/src/assets/images/logo_professional.png" alt="NEXT GAMING Logo" className="h-28 md:h-40 w-auto red-glow relative z-10" />
            <div className="absolute inset-0 bg-accent-red/20 blur-3xl rounded-full scale-50 opacity-20" />
          </motion.div>
          ...
          >
            ...
            <span className="block text-accent-red/20 mb-2">Artisan</span>
            <span className="block italic font-light serif text-accent-red drop-shadow-[0_0_15px_rgba(255,59,48,0.5)]">Pioneer</span>
          </motion.h1>
          ...
          <motion.p 
            ...
            className="max-w-md mx-auto text-xs md:text-sm leading-relaxed mb-12 font-medium tracking-tight text-white/80"
          >
      ...
      >
        <div className="w-[1px] h-20 bg-gradient-to-b from-accent-red/80 to-transparent" />
